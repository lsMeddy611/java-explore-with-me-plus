...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ru.practicum.ApiError> handleMissingServletRequestParameterException(
            MissingServletRequestParameterException e) {
        String stackTrace = getStackTrace(HttpStatus.BAD_REQUEST, e);
        String errorMessage = e.getMessage();

        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ru.practicum.ApiError(stackTrace, errorMessage, "Ошибка валидации данных", "400"));
    }
